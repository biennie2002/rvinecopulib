...
inline GluingFrankBicop::GluingFrankBicop()
{
  family_ = BicopFamily::gluing_frank;
...
inline double
GluingFrankBicop::generator(const double& u)
{
...
inline double
GluingFrankBicop::generator_inv(const double& u)
{
  double theta = double(this->parameters_(0));
...
inline double
GluingFrankBicop::generator_derivative(const double& u)
{
  double theta = double(this->parameters_(0));
  return -theta / std::expm1(theta * u);
}

// inline double GluingFrankBicop::generator_derivative2(const double &u)
//{
//    double theta = double(this->parameters_(0));
...
GluingFrankBicop::pdf_raw(const Eigen::MatrixXd& u)
{
...
GluingFrankBicop::tau_to_parameters(const double& tau)
{
...
inline double
GluingFrankBicop::parameters_to_tau(const Eigen::MatrixXd& parameters)
{
...
inline Eigen::VectorXd
GluingFrankBicop::get_start_parameters(const double tau)
{
